...
bool checkHostBoxClicked(int x, int y, int windowWidth, int windowHeight, int button, int state){
...
void checkJoinBoxClicked(int x, int y, int windowWidth, int windowHeight, int button, int state, int& gameState){
...
void checkBackBoxClicked(int x, int y, int windowWidth, int windowHeight, int button, int state, int& gameState){
...
void checkExitBoxClicked(int x, int y, int windowWidth, int windowHeight, int button, int state, int& gameState){
...
void drawUserBox(bool userBoxAlive, std::string& user_id){
	...
	if(user_id.empty()){
		glPushMatrix();
			...
			std::cout << "Username: " << temp << std::endl;
		glPopMatrix();
	}else{
		glPushMatrix();
			glColor4f(0.6f, 0.6f, 0.6f, 0.3f);
